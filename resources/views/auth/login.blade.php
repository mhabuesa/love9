...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{asset('backend')}}/assets/vendor/libs/%40form-validation/umd/styles/index.min.css" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="index.html" class="app-brand-link">
                                <span class="app-brand-text demo text-body fw-bold ">Love9 ❤️</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2 text-center">Welcome to Love9</h4>
    ...
    <script src="{{asset('backend')}}/assets/vendor/libs/%40form-validation/umd/plugin-bootstrap5/index.min.js">
    </script>
    <script src="{{asset('backend')}}/assets/vendor/libs/%40form-validation/umd/plugin-auto-focus/index.min.js">
    </script>
